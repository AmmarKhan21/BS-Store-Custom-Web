  ...
  return (
    <div className="min-h-screen bg-[var(--site-bg)] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold text-[var(--site-ink)] mb-4">Terms & Conditions</h1>
        <div className="text-sm text-[var(--site-muted)] space-y-4 leading-relaxed">
          <p>By using Bismillah Cotton & Sports Hub, you agree to these terms.</p>
          <section>
            <h2 className="font-bold text-[var(--site-ink)] mb-1">Orders & payment</h2>
          ...
          <section>
            <h2 className="font-bold text-[var(--site-ink)] mb-1">Shipping</h2>
            <p>Orders are shipped across Pakistan. Delivery times vary by city. Free delivery may apply above minimum order values.</p>
          </section>
          <section>
            <h2 className="font-bold text-[var(--site-ink)] mb-1">Returns</h2>
            <p>We offer a 7-day return policy on unused items in original packaging. Contact us to initiate a return.</p>
          </section>
          <section>
            <h2 className="font-bold text-[var(--site-ink)] mb-1">Contact</h2>
            <p>See our <Link to="/contact" className="text-[var(--site-gold)] font-bold">contact page</Link> for support.</p>
          </section>
        </div>
      </main>
      <StoreFooter />
